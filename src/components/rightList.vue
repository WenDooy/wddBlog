...
<!--                </h1>-->
            ...
            <div class="r1-body">
                <div class="contact">
                    <div>
                        <el-tooltip class="item" content="Github" placement="top" effect="dark">
                            <a :href="contant.git" target="_blank"><i class="fa fa-fw fa-github fa-2x"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" content="QQ" placement="top" effect="dark">
                            <a :href="contant.qq" target="_blank"><i class="fa fa-fw fa-qq fa-2x"></i></a>
                        </el-tooltip>
                        <el-tooltip class="item" content="wechat" placement="top" effect="dark">
                            <a :href="contant.wechat" target="_blank"><i class="fa fa-fw fa-wechat fa-2x"></i></a>
                        </el-tooltip>
                    </div>
                </div>
            </div>
...
<script>
    export default {
        ...
        data(){
            return{
                contant: {
                    git: 'https://github.com/WenDooy',
                    qq: require('../assets/img/qq.jpg'),
...
<style lang="less" scoped>
    ...
    .rightlistBox .r1-body .contact{
        text-align: center;
    }
    .rightlistBox .r1-body .contant a{
        display: inline-block;
        margin-bottom: 7px;
        position: relative;
        text-decoration: none;
    }
    .rightlistBox .r1-body .contant a:hover i{
        color:#fff;
        background: #F4692C;
    }
    .rightlistBox .r1-body .contant a i{
        display: inline-block;
        font-size: 18px;
        width:42px;
        height:42px;
